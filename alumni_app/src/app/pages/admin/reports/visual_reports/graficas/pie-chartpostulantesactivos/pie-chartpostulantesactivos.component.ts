...
@Component({
  selector: 'app-pie-chartpostulantesactivos',
  templateUrl: './pie-chartpostulantesactivos.component.html',
  styleUrl: './pie-chartpostulantesactivos.component.css'
})
export class PieChartpostulantesactivosComponent {
  ...
  ngOnInit(): void {
    this.ofertalaboralService.obtenerReportePostulacionesYAceptados().subscribe(
      (data) => {
        ...
        if (this.ofertas.length > 0 && this.cantidades.length > 0) {
